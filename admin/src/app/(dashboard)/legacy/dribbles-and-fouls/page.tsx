...
export default function LegacyDribblesPage() {
  return (
    <div className="w-[98%] px-4 py-6 mx-auto">
      <h1 className="font-evogria text-[#1D2939] text-[25px] font-normal">
        Legacy Dribbles & Fouls
      </h1>
      <p className="font-inter text-[16px] text-[#475467] font-normal">
        View and edit `dribbles_and_fouls` rows (audited).
      </p>
      <div className="mt-6">
        <LegacyTableManager table="dribbles_and_fouls" />
      </div>
    </div>
  );
}
